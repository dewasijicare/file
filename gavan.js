...
        // [PERBAIKAN TATA LETAK DIMULAI]
        try {
            // 1. Temukan kolom target (kolom kedua, yang berisi field 'Email' dst.)
            // Kita cari yang ada 'email' nya, atau fallback ke kolom kedua
            const targetColumn = mainRow.querySelector('.col-lg-6:has(label[for="email"])') || mainRow.querySelector('.col-lg-6:nth-child(2)');
            
            // 2. Temukan elemen .form-group yang salah tempat (Username, Password, Confirm)
...
                // Dipindahkan secara terbalik (prepend) agar urutannya benar: 
