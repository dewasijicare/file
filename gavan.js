...
        #betting-page-container .table-input tbody td { color: #ecf0f1 !important; vertical-align: middle; } /* <-- PERBAIKAN DI SINI */
...
S           iconSpan.className = 'input-group-text';
...
nbsp;           sidebarLogout.dataset.styled = 'true';
        }
    }
...
Click           if (event.target.id === 'agentmemberbankid') {
