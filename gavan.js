...
    const gavanThemeStyles = `
            ...
            #confirmModal .modal-footer .btn-outline-primary { background: linear-gradient(45deg, #c0392b, #e74c3c) !important; border: none !important; color: #fff !important; box-shadow: 0 0 10px #e74c3c, inset 0 0 5px rgba(255, 255, 255, .4); }
            #confirmModal .modal-footer .btn-outline-primary:hover { box-shadow: 0 0 20px #e74c3c, 0 0 30px #c0392b, inset 0 0 5px rgba(255, 255, 255, .4) !important; transform: scale(1.05); }
            #confirmModal .modal-footer .btn-danger { background: linear-gradient(45deg, #0077ff, #00eaff) !important; border: none !important; color: #fff !important; box-shadow: 0 0 10px #00eaff, inset 0 0 5px rgba(255,255,255,.4) !important; }
            #confirmModal .modal-footer .btn-danger:hover { box-shadow: 0 0 20px #00eaff, 0 0 30px #0077ff, inset 0 0 5px rgba(255,255,255,.4) !important; transform: scale(1.05); }
            ...
            /* CSS UNTUK JUDUL HALAMAN STATIS */
            #maincontent .container .text-center h3 { color: #FFD700 !important; text-transform: uppercase !important; margin-top: 1.5rem !important; margin-bottom: 1rem !important; text-shadow: 0 0 10px rgba(255, 215, 0, 0.6); }
            
            /* CSS UNTUK MENGECILKAN FONT TABEL RESULT */
            #maincontent .table-bordered tbody td { font-size: 0.85em; }
            
            /* CSS UNTUK HILANGKAN BULLET POINT WITHDRAW & KETENTUAN */
            ...
            /* Perbaikan warna teks deskripsi permainan */
            ...
            /* Style untuk Box Countdown Pembayaran */
            ...
            #maincontent .card.text-center.border-danger .card-title i { color: #FFD700 !important; text-shadow: 0 0 5px #FFD700; }
            #maincontent .card.text-center.border-danger span.countdown.badge.bg-danger { background: none !important; color: #FFD700 !important; text-shadow: 0 0 8px rgba(255, 215, 0, 0.7); font-size: 1.5rem !important; font-weight: 700; padding: 0 !important; line-height: 1.2; }
            
            /* Sembunyikan kontainer logo bank default yang duplikat */
            #maincontent .alert.alert-primary > div.mb-2 { display: none !important; }
            
            /* Mengatur tombol QRIS di info deposit */
            ...
            #maincontent .alert.alert-primary a.btn-secondary[href="/deposit-qris"] strong { color: #2c3e50 !important; }
            
            /* Mengatur Status Badge (Ditolak, Sukses, dll) */
            ...
            #maincontent .badge.bg-warning { background: linear-gradient(45deg, #ffd700, #ffa500) !important; color: #2c3e50 !important; box-shadow: 0 0 5px rgba(255, 215, 0, 0.5); border: 1px solid #ffd700; text-shadow: 0 1px 1px rgba(255,255,255,0.2); font-weight: 600; }
            #maincontent .badge.bg-primary { background: linear-gradient(45deg, #0077ff, #00eaff) !important; color: #fff !important; box-shadow: 0 0 5px rgba(0, 234, 255, 0.5); border: 1px solid #00eaff; text-shadow: 0 1px 2px rgba(0,0,0,0.3); font-weight: 600; }
            
            /* Mengatur style untuk header "Input" di tabel bet multi-line */
